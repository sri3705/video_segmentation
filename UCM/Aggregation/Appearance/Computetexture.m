function [STT_max,STT_mean]=Computetexture(labelledlevelvideo,numberofsuperpixelsperframe,concc,conrr,cim,mapped,thedepth,stsimilarities,temporaldepth,printonscreen, options, filenames)
