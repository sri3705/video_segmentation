function valid=Getthesegments(basenameforucm2,numberforucm2,closureforucm2,startNumberforucm2,...
...
for i=startNumberforucm2:(noFrames+startNumberforucm2-1)
    ...
    %%% compute globalPb %%%
%     clearvars -except imgFile outFile ucmf ucm2f i; clear all;
%     close all; clc;
    ...
    [gPb_orient, gPb_thin, textons] =globalPb(imgFile, outFile, rsz, count, saveworkimages, printthetextonscreen);
    if (~saveworkfiles)
        delete(outFile);
    end
    clear gPb_thin;
