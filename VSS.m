...
filename_sequence_basename_frames_or_video.basename=realbasename;
filename_sequence_basename_frames_or_video.number_format=realnumberformat;
filename_sequence_basename_frames_or_video.closure=realclosure;
